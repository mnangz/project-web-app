  ...
  private getSortedData(data: EmployeesTableItem[]) {
    ...
    return data.sort((a, b) => {
      ...
      switch (this.sort.active) {
        ...
        case 'isNurse': return compare(+a.isNurse, +b.isNurse, isAsc);
        case 'isEntrance': return compare(+a.isEntrance, +b.isEntrance, isAsc);
        case 'isEntrance': return compare(+a.isEmployee, +b.isEmployee, isAsc);
        default: return 0;
      }
    });
  }
